...
interface ThermalReceiptProps {
  bill: Bill;
  /** After the first bill in a bulk print — skip repeating the shop header. */
  continuation?: boolean;
  /** Thank-you, software footer, and cutter feed. Only the last bulk bill should keep these. */
  showClosing?: boolean;
}
...
export function ThermalReceipt({
  ...
  return (
    ...
    >
      {!continuation && <div className="receipt-top-spacer" aria-hidden />}
      ...
      {continuation && <div className="receipt-rule mx-2 receipt-bill-sep" />}
